...
def create_all_tools(webhook_base_url: str) -> List[Tuple[str, str, bool, str]]:
    ...
    tools = [
        ...
        },
        {
            ...
            "description": "Gets all practitioners who work at a specific business. Use like 'What practitioners do you have at [location]?' Requires business_id from location-resolver first. This is like looking at a staff directory.",
            ...
            "properties": {
                ...
                "dialedNumber": {
                    "type": "string",
                    "description": "The clinic number that was dialed"
                },
                "sessionId": {
                    "type": "string",
        ...
        },
        {
            ...
            "description": "Gets practitioners with availability on a specific date at a specific business. Use like 'Who has availability at [location] this week'. Requires BOTH business_id AND date. Returns only practitioners with actual openings.",
