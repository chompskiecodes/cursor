    ...
    tools = [
        {
            ...
            "description": "Resolves ANY location reference to a specific clinic location ID. Call when location is mentioned (main, usual, Balmain, city, your clinic, etc). Returns one of two responses: 1) SUCCESS: Returns location_id (a number) - use this in subsequent tools 2) NEEDS CLARIFICATION: Returns needs_clarification = \
        ...
        },
        {
            ...
            "description": "Confirms location after location-resolver needs clarification. ONLY use after you've: 1) Received needs_clarification = \
                true from location-resolver 2) Read the exact message to the caller 3) Received their response. Pass their EXACT words in userResponse along with the options array from location-resolver. Returns the confirmed location_id to use in booking.",
        ...
        },
        {
            ...
            "description": "Creates the actual appointment booking. This is the ONLY tool that books appointments. ONLY call after: 1) Caller has verbally confirmed they want the specific time 2) You have asked for and received their full name. Required formats: appointmentDate as YYYY-MM-DD,\
