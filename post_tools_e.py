"""
ElevenLabs Enhanced/Parallel Tools Creator
Creates webhook tools for the Voice Booking System using enhanced/parallel endpoints where possible
"""
...
def create_all_tools(webhook_base_url: str) -> List[Tuple[str, str, bool, str]]:
    ...
    tools = [
        # location_resolver (unchanged)
        {
            ...
            "properties": {
                "locationQuery": {"type": "string", "description": "The location reference to resolve (exactly what caller said)", "dynamic_variable": "", "constant_value": ""},
                "sessionId": {"type": "string", "description": "Current conversation session ID", "dynamic_variable": "", "constant_value": ""},
                "dialedNumber": {"type": "string", "description": "The clinic phone number that was dialed", "dynamic_variable": "", "constant_value": ""},
                "callerPhone": {"type": "string", "description": "The caller's phone number", "dynamic_variable": "", "constant_value": ""},
                "systemCallerID": {"type": "string", "description": "System-provided caller ID if available", "dynamic_variable": "", "constant_value": ""}
            }
        },
        # confirm_location (unchanged)
        {
            ...
            "properties": {
                "userResponse": {"type": "string", "description": "User's exact response to location options", "dynamic_variable": "", "constant_value": ""},
                "options": {"type": "array", "description": "The location options array from location-resolver", "items": {"type": "string", "description": "Location name option"}},
                "sessionId": {"type": "string", "description": "Current conversation session ID", "dynamic_variable": "", "constant_value": ""},
                "dialedNumber": {"type": "string", "description": "The clinic phone number that was dialed", "dynamic_variable": "", "constant_value": ""},
                "callerPhone": {"type": "string", "description": "The caller's phone number", "dynamic_variable": "", "constant_value": ""}
            }
        },
        # enhanced_find_next_available
        {
            "name": "enhanced_find_next_available",
            "description": "Finds the FIRST/NEXT available appointment across multiple days using the enhanced parallelized logic. Use when caller asks: 'when's the next available', 'earliest appointment', 'first available', 'soonest you have', or doesn't specify a date. Searches forward from today to find the first open slot. Can search by practitioner, service, or both. Returns ONE appointment option - the earliest available.",
            "endpoint": "/enhanced/find-next-available",
            "required": ["sessionId", "dialedNumber"],
            "properties": {
                "service": {"type": "string", "description": "Service name (e.g., 'Massage', 'Acupuncture (Initial)')", "dynamic_variable": "", "constant_value": ""},
                "practitioner": {"type": "string", "description": "Practitioner name if specified", "dynamic_variable": "", "constant_value": ""},
                "business_id": {"type": "string", "description": "Business ID from location-resolver if location was mentioned", "dynamic_variable": "", "constant_value": ""},
                "businessName": {"type": "string", "description": "Business name for response formatting", "dynamic_variable": "", "constant_value": ""},
                "maxDays": {"type": "number", "description": "Maximum days to search ahead (default 14)", "dynamic_variable": "", "constant_value": ""},
                "sessionId": {"type": "string", "description": "Current conversation session ID", "dynamic_variable": "", "constant_value": ""},
                "dialedNumber": {"type": "string", "description": "The clinic phone number that was dialed", "dynamic_variable": "", "constant_value": ""}
            }
        },
        # availability_checker (unchanged)
        {
            ...
            "properties": {
                "practitioner": {"type": "string", "description": "The practitioner's name", "dynamic_variable": "", "constant_value": ""},
                "date": {"type": "string", "description": "The date to check (e.g., 'tomorrow', 'Monday', '2024-12-25')", "dynamic_variable": "", "constant_value": ""},
                "appointmentType": {"type": "string", "description": "The type of appointment/service if specified", "dynamic_variable": "", "constant_value": ""},
                "location": {"type": "string", "description": "The location name if not yet resolved", "dynamic_variable": "", "constant_value": ""},
                "business_id": {"type": "string", "description": "The resolved business ID from location-resolver", "dynamic_variable": "", "constant_value": ""},
                "sessionId": {"type": "string", "description": "Current conversation session ID", "dynamic_variable": "", "constant_value": ""},
                "dialedNumber": {"type": "string", "description": "The clinic phone number that was dialed", "dynamic_variable": "", "constant_value": ""},
                "callerPhone": {"type": "string", "description": "The caller's phone number", "dynamic_variable": "", "constant_value": ""}
            }
        },
        # appointment_handler (unchanged)
        {
            ...
            "properties": {
                ...
                "callerPhone": {"type": "string", "description": "The caller's phone number", "dynamic_variable": "", "constant_value": ""},
                "systemCallerID": {"type": "string", "description": "System-provided caller ID if available", "dynamic_variable": "", "constant_value": ""},
                "patientName": {"type": "string", "description": "Full name of the patient (required before booking)", "dynamic_variable": "", "constant_value": ""},
                "patientPhone": {"type": "string", "description": "Patient's phone number (if different from caller)", "dynamic_variable": "", "constant_value": ""},
                "practitioner": {"type": "string", "description": "The practitioner's name", "dynamic_variable": "", "constant_value": ""},
                "appointmentType": {"type": "string", "description": "Exact service name (e.g., 'Massage', 'Acupuncture (Initial)', 'Acupuncture (Follow up)')", "dynamic_variable": "", "constant_value": ""},
                "appointmentDate": {"type": "string", "description": "Appointment date in YYYY-MM-DD format", "dynamic_variable": "", "constant_value": ""},
                "appointmentTime": {"type": "string", "description": "Appointment time in HH:MM format (24-hour)", "dynamic_variable": "", "constant_value": ""},
                "business_id": {"type": "string", "description": "The resolved business ID (get from location-resolver first)", "dynamic_variable": "", "constant_value": ""},
                "notes": {"type": "string", "description": "Optional notes about the appointment", "dynamic_variable": "", "constant_value": ""}
            }
        },
        # cancel_appointment (unchanged)
        {
            ...
            "properties": {
                ...
                "callerPhone": {"type": "string", "description": "The caller's phone number", "dynamic_variable": "", "constant_value": ""},
                "systemCallerID": {"type": "string", "description": "System-provided caller ID if available", "dynamic_variable": "", "constant_value": ""},
                "appointmentId": {"type": "string", "description": "Specific appointment ID if mentioned", "dynamic_variable": "", "constant_value": ""},
                "appointmentDetails": {"type": "string", "description": "Natural language description of the appointment to cancel", "dynamic_variable": "", "constant_value": ""},
                "reason": {"type": "string", "description": "Reason for cancellation if provided", "dynamic_variable": "", "constant_value": ""}
            }
        },
        # get_practitioner_services (unchanged)
        {
        ...
        # get_practitioner_info (unchanged)
        {
        ...
        # get_location_practitioners_parallel
        {
            "name": "get_location_practitioners_parallel",
            "description": "Shows WHO works at a location (just names, not availability) using the parallel endpoint. Use when caller asks: 'Who works at [location]?' or 'What practitioners do you have at [location]?' Requires business_id from location-resolver first. This is like looking at a staff directory.",
            "endpoint": "/get-location-practitioners-parallel",
            "required": ["business_id", "businessName", "dialedNumber", "sessionId"],
            "properties": {
                "business_id": {"type": "string", "description": "Business ID from location-resolver", "dynamic_variable": "", "constant_value": ""},
                "businessName": {"type": "string", "description": "Business name for response formatting", "dynamic_variable": "", "constant_value": ""},
                "dialedNumber": {"type": "string", "description": "The clinic phone number that was dialed", "dynamic_variable": "", "constant_value": ""},
                "sessionId": {"type": "string", "description": "Current conversation session ID", "dynamic_variable": "", "constant_value": ""}
            }
        },
        # enhanced_get_available_practitioners
        {
            "name": "enhanced_get_available_practitioners",
            "description": "Shows WHO has appointments available at a location on a specific date using the enhanced parallelized logic. Use when caller is flexible: 'Who's available at [location] tomorrow?' or 'Any practitioner at [location] this week'. Requires BOTH business_id AND date. Returns only practitioners with actual openings.",
            "endpoint": "/enhanced/get-available-practitioners",
            "required": ["business_id", "businessName", "date", "dialedNumber", "sessionId"],
            "properties": {
                "business_id": {"type": "string", "description": "Business ID from location-resolver", "dynamic_variable": "", "constant_value": ""},
                "businessName": {"type": "string", "description": "Business name for response formatting", "dynamic_variable": "", "constant_value": ""},
                "date": {"type": "string", "description": "Date to check availability (e.g., 'today', 'tomorrow')", "dynamic_variable": "", "constant_value": ""},
                "dialedNumber": {"type": "string", "description": "The clinic phone number that was dialed", "dynamic_variable": "", "constant_value": ""},
                "sessionId": {"type": "string", "description": "Current conversation session ID", "dynamic_variable": "", "constant_value": ""}
            }
        }
